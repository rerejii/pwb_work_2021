    ...
    def fit(self,
        ...
        while self.shuf_train_ds_cls.get_remain_data() is not 0:
            ...
            # if True:
                ...
                if epoch % 4 == 0:
                    print('===== update loss =====')
                    print('before: ' + str(self.net_cls.gen_optimizer.learning_rate.numpy()))
                    print(self.net_cls.gen_optimizer.learning_rate)
                    self.net_cls.gen_optimizer.learning_rate = self.net_cls.gen_optimizer.learning_rate * 0.1
                    print('after: ' + str(self.net_cls.gen_optimizer.learning_rate.numpy()))
