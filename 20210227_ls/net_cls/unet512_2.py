...
# ========== NET ===========
    def _Generator(self):
        down_stack = [
            ...
            self._downsample(128, 4),  # (bs, 128, 128, 64)
            self._downsample(256, 4),  # (bs, 64, 64, 128)
            self._downsample(512, 4),  # (bs, 32, 32, 256)
        ...
        up_stack = [
            ...
            self._upsample(512, 4),  # (bs, 32, 32, 512)
            self._upsample(256, 4),  # (bs, 64, 64, 256)
            self._upsample(128, 4),  # (bs, 128, 128, 128)
            self._upsample(64, 4),
        ]
