...
# img = cv2.imread('E:/work/myTensor/dataset2/img/17H-0863-1_L0002-old/L0002.png')
...
# img = cv2.imread('Z:/hayakawa/binary/20210128/unet_use-bias_beta_otsu2_deep_multi-loss/unet_use-bias_beta_otsu2_deep_multi-loss-D/generator_L0012.png', 0)
...
cv2.imwrite('crop_img/otsu_l_c5.png', crop_img)
