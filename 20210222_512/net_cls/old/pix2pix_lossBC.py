...
# ************ クラス外呼び出し関数 ************
    ...
    def generator_loss(self, disc_generated_output, gen_output, target):
        ...
        # gen_bin = self.
        gen_loss_2 = self.loss_object(self.binary_from_data(target), self.binary_from_data(gen_output))
        total_gen_loss = gan_loss + gen_loss_2
    ...
    def binary_from_data(self, data):
        return tf.cast(tf.greater_equal(data, 0), tf.float32)
