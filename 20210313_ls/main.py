...
FIN_ACTIVATE = 'None'
#  '20200223'
OUT_ROOT_FOLDER_NAME = '20210313'
#  '20200223'
EPOCH_OUT_ROOT_FOLDER_NAME = '20210313'
#  DR*
TFRECORD_FOLDER_NAME = 'DR-20210208-valid0-more'
#  Img*
...
if DATASET == 'A':
    ...
    HLS_IMAGE = ['img/17H-0863-1_L0006-new/L0006_hls.png', 'img/17H-0863-1_L0011/L0011_hls.png', 'img/17H-0863-1_L0017/L0017_hls.png']
elif DATASET == 'B':
    ...
    HLS_IMAGE = ['img/17H-0863-1_L0003/L0003_hls.png', 'img/17H-0863-1_L0005/L0005_hls.png', 'img/17H-0863-1_L0009/L0009_hls.png']
elif DATASET == 'C':
    ...
    HLS_IMAGE = ['img/17H-0863-1_L0002-old/L0002_hls.png', 'img/17H-0863-1_L0008/L0008_hls.png', 'img/17H-0863-1_L0013/L0013_hls.png']
elif DATASET == 'D':
    ...
    HLS_IMAGE = ['img/17H-0863-1_L0007/L0007_hls.png', 'img/17H-0863-1_L0012/L0012_hls.png', 'img/17H-0863-1_L0014/L0014_hls.png']
elif DATASET == 'E':
    ...
    HLS_IMAGE = ['img/17H-0863-1_L0004/L0004_hls.png', 'img/17H-0863-1_L0015/L0015_hls.png', 'img/17H-0863-1_L0016/L0016_hls.png']
elif DATASET == 'F':
    ...
    HLS_IMAGE = ['img/17H-0863-1_L0001/L0001_hls.png', 'img/17H-0863-1_L0010/L0010_hls.png', 'img/17H-0863-1_L0018/L0018_hls.png']
...
# elif TASK == 'eva' or TASK =='eva_train-ds' or T:
    ...
    for i in range(len(GENERATOR_IMAGE)):
        print(OUT_ROOT_FOLDER + '/' + GENERATOR_IMAGE_NAME[i] + '.png')
        gen_cls.run(img_path=DATASET_PATH + '/' + GENERATOR_IMAGE[i],
                    out_path=OUT_ROOT_FOLDER + '/' + GENERATOR_IMAGE_NAME[i] + '.png',
    ...
    PlotFunc.multi_csv_plot(
        csv_path=path_cls.make_csv_path('step_accuracy.csv'),
        title=OUT_ROOT_FOLDER + '/[test_f3]_' + os.path.basename(OUT_ROOT_FOLDER),
        label=DATASET,
        items=['test_accuracy', 'test_F1', 'test_Fd5', 'test_F2', 'test_N_F1', 'test_N_Fd5', 'test_N_F2', 'test_IoU', 'test_N_IoU'],
        ylim=[0.9, 1]
    )
    PlotFunc.multi_csv_plot(
        csv_path=path_cls.make_csv_path('step_accuracy.csv'),
        title=OUT_ROOT_FOLDER + '/[validation_f3]_' + os.path.basename(OUT_ROOT_FOLDER),
        label=DATASET,
        items=['validation_accuracy', 'validation_F1', 'validation_Fd5', 'validation_F2', 'validation_N_F1', 'validation_N_Fd5', 'validation_N_F2', 'validation_IoU', 'validation_N_IoU'],
        ylim=[0.9, 1]
    )
    # PlotFunc.multi_csv_plot(
    #     csv_path=path_cls.make_csv_path('step_accuracy.csv'),
