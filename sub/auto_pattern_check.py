...
# directorys_2 = ['Z:/hayakawa/binary/20210222/unet_use-bias_beta/unet_use-bias_beta-D']
if not directorys_2:
    sys.exit()
...
for i in tqdm(range(len(directorys_2)), desc='Processed check pattern'):
    ...
    for out_path in out_pathset:  # A, B, C,...
        ...
        os.rename(dirname + '/View.png', dirname+'/View_'+img_name+'.png')

        total_result = check_eveluate(path=directorys_2[i] + '/', csv_name='L'+str(img_n)+'_PatternResult.csv', file_count=1)
