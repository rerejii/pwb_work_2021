...
root_path = 'C:/Users/hayakawa/work/mytensor/dataset2/Img-256-valid0-more/'
img_list = ['17H-0863-1_L0015', '17H-0863-1_L0017', '17H-0863-1_L0018']

for img_name in img_list:
    print(img_name)
    # root_img_path = 'C:/Users/hayakawa/work/mytensor/dataset2/Img-256-valid0-more/17H-0863-1_L0009/Sample'
    # root_ans_path = 'C:/Users/hayakawa/work/mytensor/dataset2/Img-256-valid0-more/17H-0863-1_L0009/Answer'
    # root_out_path = 'C:/Users/hayakawa/work/mytensor/dataset2/Img-256-valid0-more/17H-0863-1_L0009/maskline'
    root_img_path = root_path + img_name + '/Sample'
    root_ans_path = root_path + img_name + '/Answer'
    root_out_path = root_path + img_name + '/maskline'
