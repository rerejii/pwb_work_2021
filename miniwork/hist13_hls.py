...
black_folder = 'black_only_hls'
white_folder = 'white_only_hls'
double_folder = 'double_hls'
...
for path_i in range(len(csv_black_path_list)):
    ...
    plt.xlim([-2, 256+2])
    plt.ylim([0, 30000000])
    plt.title(white_folder + '/' + fname + '_white_only_hls')
    plt.savefig(white_folder + '/' + fname + '_white_only_hls.png')
    plt.figure()
    ...
    plt.xlim([-2, 256+2])
    plt.ylim([0, 7500000])
    plt.title(black_folder + '/' + fname + '_black_only_hls')
    plt.savefig(black_folder + '/' + fname + '_black_only_hls.png')
    plt.figure()
    ...
    plt.xlim([-2, 256+2])
    plt.ylim([0, 30000000])
    plt.title(double_folder + '/' + fname + '_double_hls')
    plt.legend(loc='upper right')
    plt.savefig(double_folder + '/' + fname + '_double_hls.png')
...
plt.xlim([-2, 256 + 2])
plt.ylim([0, 30000000])
plt.title(white_folder + '/' + 'ave_white_only_hls')
plt.savefig(white_folder + '/' + 'ave_white_only_hls.png')
plt.figure()
...
plt.xlim([-2, 256 + 2])
plt.ylim([0, 7500000])
plt.title(black_folder + '/' + 'ave_black_only_hls')
plt.savefig(black_folder + '/' + 'ave_black_only_hls.png')
plt.figure()
pbar.update(1)  # プロセスバーを進行