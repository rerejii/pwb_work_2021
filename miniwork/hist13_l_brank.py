...
black_folder = 'black_only_l_brank'
white_folder = 'white_only_l_brank'
double_folder = 'double_l_brank'
...
ret_l = [159, 120, 145, 125, 145, 137, 135, 139, 163, 166, 164, 178, 103, 121, 166, 133, 165, 146,]
...
for path_i in range(len(csv_black_path_list)):
    ...
    plt.xlim([-2, 256+2])
    plt.ylim([0, 30000000])
    plt.title(white_folder + '/' + fname + '_white_only_l_brank')
    plt.savefig(white_folder + '/' + fname + '_white_only_l_brank.png')
    plt.figure()
    ...
    plt.xlim([-2, 256+2])
    plt.ylim([0, 7500000])
    plt.title(black_folder + '/' + fname + '_black_only_l_brank')
    plt.savefig(black_folder + '/' + fname + '_black_only_l_brank.png')
    plt.figure()
    ...
    plt.xlim([-2, 256+2])
    plt.ylim([0, 30000000])
    # plt.title(double_folder + '/' + fname + '_double_l_brank')
    plt.legend(loc='upper right')
    plt.savefig(double_folder + '/' + fname + '_double_l_brank.png')
...
plt.xlim([-2, 256 + 2])
plt.ylim([0, 30000000])
plt.title(white_folder + '/' + 'ave_white_only_l_brank')
plt.savefig(white_folder + '/' + 'ave_white_only_l_brank.png')
plt.figure()
...
plt.xlim([-2, 256 + 2])
plt.ylim([0, 7500000])
plt.title(black_folder + '/' + 'ave_black_only_l_brank')
plt.savefig(black_folder + '/' + 'ave_black_only_l_brank.png')
plt.figure()
pbar.update(1)  # プロセスバーを進行