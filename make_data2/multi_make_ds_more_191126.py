...
if __name__ == "__main__":
    ...
    def main_proc(crop_index_list, sam_norm, ans_norm, path_index):
        def crop_out(_sam_out_path, _ans_out_path, crop_top, crop_left):
            ...
            tf.io.write_file(filename=_sam_out_path, contents=sam_byte)
